...
[_QWERTY] = LAYOUT_planck_grid(
    ESC_NUM,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC,
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_DEL,  S(KC_A),   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_UNDS,    KC_PLUS,    KC_LCBR, KC_RCBR, KC_PIPE,
